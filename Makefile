...
TAG = v$(shell grep -E '__version__ = ".*"' TCgram/__init__.py | cut -d\" -f2)
...
clean-api:
	$(RM) TCgram/errors/exceptions TCgram/raw/all.py TCgram/raw/base TCgram/raw/functions TCgram/raw/types
